...
class BaseModel
{
    ...
    Const DELETED_OPEN = '0';
    Const DELETED_CLOSE = '1';
    Const DELETED_DEL = '2';
//    Const DELETED_ENUM_ARRAY = array(self::DELETED_OPEN => '开启',
...
//      self::DELETED_DEL => '删除');
    ...
    {
        $this->_db_config = webadmin_load_config('Config_'.ENV,'database');
        $this->_redis_config = webadmin_load_config('Config_'.ENV, 'redis');
