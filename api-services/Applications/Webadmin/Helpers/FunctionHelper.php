 ...
 * @return type
 */
function webadmin_load_config($file_name='',$config_param='')
{
 ...
 **/
function webadmin_in($data, $force = false, $htmlspecialchar = true) {
	if (is_string ( $data )) {
...
// 获取客户端IP地址
function webadmin_get_client_ip() {
	$ip = '';
...
function webadmin_check_mobile($num = '')
{
